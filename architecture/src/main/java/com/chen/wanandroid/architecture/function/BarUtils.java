...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (((Application)Global.getGlobalConfig().get("app")).getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, ((Application)Global.getGlobalConfig().get("app")).getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = ((Application)Global.getGlobalConfig().get("app")).getSystemService("statusbar");
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = ((Application)Global.getGlobalConfig().get("app"))
                        .getResources()
    ...
    public static boolean isSupportNavBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            WindowManager wm = (WindowManager) ((Application)Global.getGlobalConfig().get("app")).getSystemService(Context.WINDOW_SERVICE);
            if (wm == null) {
                return false;
            }
        ...
        boolean menu = ViewConfiguration.get(((Application)Global.getGlobalConfig().get("app"))).hasPermanentMenuKey();
